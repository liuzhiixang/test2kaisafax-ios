...
//#import "ZXResult.h"
#import "SQZXCaptureDelegate.h"

@protocol SQZXCaptureDelegate, ZXReader;
@class ZXDecodeHints;

@interface SQZXCapture : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate, CAAction>

@property (nonatomic, assign) int camera;
@property (nonatomic, strong) AVCaptureDevice *captureDevice;
@property (nonatomic, copy) NSString *captureToFilename;
@property (nonatomic, weak) id<SQZXCaptureDelegate> delegate;
