...
@interface SQScanNative()<AVCaptureMetadataOutputObjectsDelegate>
{
...
//扫码结果
@property (nonatomic, strong) NSMutableArray<SQScanResult*> *arrayResult;
 ...
 *  扫码结果返回
 */
@property(nonatomic,copy)void (^blockScanResult)(NSArray<SQScanResult*> *array);



@end

@implementation SQScanNative
...
- (id)initWithPreView:(UIView*)preView ObjectType:(NSArray*)objType cropRect:(CGRect)cropRect success:(void(^)(NSArray<SQScanResult*> *array))block
{
    if (self = [super init]) {
...
- (void)initParaWithPreView:(UIView*)videoPreView ObjectType:(NSArray*)objType cropRect:(CGRect)cropRect success:(void(^)(NSArray<SQScanResult*> *array))block
{
    ...
    [[self stillImageOutput] captureStillImageAsynchronouslyFromConnection:stillImageConnection
                                                         completionHandler:^(CMSampleBufferRef imageDataSampleBuffer, NSError *error)
     {
         ...
         if (imageDataSampleBuffer)
         {
             ...
             for (SQScanResult* result in _arrayResult) {
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    for(AVMetadataObject *current in metadataObjects)
    {
        if ([current isKindOfClass:[AVMetadataMachineReadableCodeObject class]] )
        {
            ...
            {
                SQScanResult *result = [SQScanResult new];
