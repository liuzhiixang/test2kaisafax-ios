//
//  UIImage-PhysicalChange.m
//
//  Created by Hardy Macia on 7/1/09.
//  Copyright 2009 Catamount Software. All rights reserved.
//

#import "UIImage+PhysicalChange.h"
#import <Accelerate/Accelerate.h>

CGFloat DegreesToRadians(CGFloat degrees) {return degrees * M_PI / 180;};
CGFloat RadiansToDegrees(CGFloat radians) {return radians * 180/M_PI;};

@implementation UIImage (PhysicalChange)
...
- (UIImage *)accelerateBlur:(CGFloat)blur
{
    ...
    CGImageRef img = [self imageByScalingProportionallyToSize:CGSizeMake(self.size.width, self.size.height)].CGImage;
    ...
    uint32_t wh = (uint32_t)boxSize;
    error = vImageBoxConvolve_ARGB8888(&inBuffer, &outBuffer, NULL, 0, 0, wh, wh, NULL, kvImageEdgeExtend);
