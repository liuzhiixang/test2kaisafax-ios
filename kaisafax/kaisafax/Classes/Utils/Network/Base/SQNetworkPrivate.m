...
@implementation SQNetworkPrivate
...
+ (void)addDoNotBackupAttribute:(NSString *)path {
    ...
    if (error) {
        SQNLog(@"error to set do not backup attribute, error = %@", error);
    }
}
...
@implementation SQBaseRequest (RequestAccessory)

- (void)toggleAccessoriesWillStartCallBack {
    for (id<SQRequestAccessory> accessory in self.requestAccessories) {
...
@implementation SQBatchRequest (RequestAccessory)
