...
{
    if ([_delegate respondsToSelector:@selector(easyTableViewDidEndDecelerating:)]) {
        [_delegate easyTableViewDidEndDecelerating:self];
    }
}

- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    if ([_delegate respondsToSelector:@selector(easyTableViewDidScroll:)]) {
        [_delegate easyTableViewDidScroll:self];
    }
}
