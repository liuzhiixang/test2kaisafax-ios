...
- (void)setupSubviews {
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-8-[lb]-(>=0)-[cb]-0-|"
                                                                 options:0
                                                                 metrics:nil
                                                                   views:views]];
...
- (void)setContentString:(NSString *)contentString {
    ...
    CGSize size = [_contentString boundingRectWithSize:_label.size
...
- (void)addAttributedString:(NSAttributedString *)title
    ...
    NSAssert([target respondsToSelector:selector], @"target找不到对应方法");
