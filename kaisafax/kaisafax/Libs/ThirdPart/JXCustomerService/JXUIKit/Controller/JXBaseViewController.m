...
@property(nonatomic, copy) void (^actionBlock)(id sender);    // navigationBar右边按钮事件block
...
//    [btn setImage:JXChatImage(@"back_unclick") forState:UIControlStateNormal];
    [btn setImage:[UIImage imageNamed:@"white_left"] forState:UIControlStateNormal];
...
- (void)configureCompleteRightBarItemWithActionBlock:(void (^)(id sender))finishBlock {
    [self setupRightBarButtonItemWithTitle:@"完成" andAction:finishBlock];
}
