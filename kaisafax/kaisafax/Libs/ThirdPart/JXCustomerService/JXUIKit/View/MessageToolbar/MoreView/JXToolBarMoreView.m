...
- (void)layoutSubviews {
    ...
    _titleLabel.frame = CGRectMake(_cellImageView.left - 5, _cellImageView.bottom, _cellImageView.width + 10,
                                   self.height - _cellImageView.height);
...
- (void)loadContentView {
    _seplineView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.width, JXMinPixels)];
    ...
    _contentView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, self.width, self.height)
...
- (void)layoutSubviews {
    [super layoutSubviews];
    _seplineView.frame = CGRectMake(0, 0, self.width, JXMinPixels);
